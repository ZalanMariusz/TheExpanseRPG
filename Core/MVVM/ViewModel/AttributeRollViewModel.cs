...
namespace TheExpanseRPG.Core.MVVM.ViewModel
{
    public class AttributeRollViewModel : ViewModelBase
    {
        ...
        public AttributeRollType SelectedAttributeRollType { get { return _selectedAttributeRollType; } set { _selectedAttributeRollType = value; OnPropertyChanged(); } }
        public DiceRollService DiceRollService { get; set; }
        public RelayCommand RollAbilityCommand { get; set; }
        ...
        public AttributeRollViewModel(DiceRollService diceRollService)
        {
            DiceRollService = diceRollService;
            //AttributeRollType = AttributeRollType.AllRandom;
            RollAbilityCommand = new RelayCommand(o => true, RollAndSetAttribute);
        ...
        private void SetAttributeValue(object attributeName, RollResult roll)
        {
            ...
            PropertyInfo attributeProperty = typeof(AttributeRollViewModel).GetProperties().First(x => x.Name == attributeName.ToString());
            ...
            typeof(AttributeRollViewModel).GetProperties().First(x => x.Name == attributeRollPropertyName.ToString()).SetValue(this, roll.GetRollResultSumValue());
        }
