...
namespace TheExpanseRPG.Core.Services
{
    public class CharacterBackgroundListService : IExpanseService
    {
        ...
        public CharacterBackgroundListService(AbilityFocusListService abilityFocusListService, TalentListService talentListService, SqliteDatabaseConnectorService dbConnector)
        {
        ...
        private void PopulateBackgroundList(DataSet backgroundData)
        {
            ...
            DataTable backgdroungTalents = backgroundData.Tables["BackgroundTalents"]!;
            ...
            foreach (DataRow backgroundMain in backgroundData.Tables["Backgrounds"]!.Rows)
            {
                ...
                EnumerableRowCollection talentsByBackgroundName = backgdroungTalents.AsEnumerable()
                    .Where(x => x.Field<string>("BackgroundName") == backgroundMain["BackgroundName"].ToString());
                ...
                CharacterBackgroundList.Add(
                    new CharacterBackGround(
                        ...
                        (CharacterAbilityName)Enum.Parse(typeof(CharacterAbilityName), backgroundMain["AbilityBonus"].ToString()!),
