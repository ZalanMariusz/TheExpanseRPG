...
DROP TABLE IF EXISTS "ProfessionTalent";
CREATE TABLE IF NOT EXISTS "ProfessionTalent" (
	"ProfessionName"	TEXT,
	"TalentName"	TEXT,
	PRIMARY KEY("ProfessionName","TalentName"),
	FOREIGN KEY("TalentName") REFERENCES "Talent"("TalentName"),
	FOREIGN KEY("ProfessionName") REFERENCES "Profession"("ProfessionName")
);
DROP TABLE IF EXISTS "Profession";
CREATE TABLE IF NOT EXISTS "Profession" (
	"ProfessionName"	TEXT,
	"ProfessionDescription"	TEXT NOT NULL,
	"SocialClassId"	INTEGER NOT NULL,
	PRIMARY KEY("ProfessionName"),
	FOREIGN KEY("SocialClassId") REFERENCES "SocialClass"("SocialClassId")
);
DROP TABLE IF EXISTS "ProfessionFocus";
CREATE TABLE IF NOT EXISTS "ProfessionFocus" (
	"ProfessionName"	TEXT,
	"AbilityId"	INTEGER,
	"FocusName"	TEXT,
	PRIMARY KEY("ProfessionName","AbilityId","FocusName"),
	FOREIGN KEY("AbilityId","FocusName") REFERENCES "AbilityFocus"("AbilityId","FocusName")
);
...
INSERT INTO "ProfessionTalent" ("ProfessionName","TalentName") VALUES ('Artist','Artistry'),
 ('Artist','Performance'),
 ('Athlete','Agility'),
 ('Athlete','Quick Reflexes'),
 ('Brawler','Grappling Style'),
 ('Brawler','Striking Style'),
 ('Clergy','Inspire'),
 ('Clergy','Oratory'),
 ('Commander','Command'),
 ('Commander','Tactical Awareness'),
 ('Criminal','Burglary'),
 ('Criminal','Scouting'),
 ('Dilettante','Improvisation'),
 ('Dilettante','Know-It-All'),
 ('Executive','Command'),
 ('Executive','Intrigue'),
 ...
 ('Professional','Expertise(Focus)'),
 ('Scavenger','Maker'),
 ('Scholar','Expertise(Focus)'),
 ('Scholar','Knowledge'),
 ('Security','Protector'),
 ('Socialite','Attractive'),
 ('Socialite','Contacts'),
 ('Soldier','Tactical Awareness'),
 ('Survivalist','Fringer'),
 ('Survivalist','Tactical Awareness'),
 ('Technician','Expertise(Focus)'),
 ('Technician','Hacking'),
 ('Technician','Maker'),
 ('Security','Dual Weapon Style'),
 ('Security','Grappling Style'),
 ('Security','Overwhelm Style'),
 ('Security','Pistol Style'),
 ('Security','Rifle Style'),
 ('Security','Self-Defense Style'),
 ('Security','Single Weapon Style'),
 ('Security','Striking Style'),
 ('Security','Thrown Weapon Style'),
 ('Security','Two-Handed Style'),
 ('Soldier','Dual Weapon Style'),
 ('Soldier','Grappling Style'),
 ('Soldier','Overwhelm Style'),
 ('Soldier','Pistol Style'),
 ('Soldier','Rifle Style'),
 ('Soldier','Self-Defense Style'),
 ('Soldier','Single Weapon Style'),
 ('Soldier','Striking Style'),
 ('Soldier','Thrown Weapon Style'),
 ('Soldier','Two-Handed Style');
INSERT INTO "Profession" ("ProfessionName","ProfessionDescription","SocialClassId") VALUES ('Artist','You are about expression, whether it is sharing your sense of what is beautiful or expressing your pain or outrage in a form others can understand. You may or may not be making a living at it, but you need to express yourself regardless.',0),
 ('Athlete','You pit yourself against physical challenges, from other teams and rival athletes to your own limits and personal best. Your work involves a lot of training and practice to stay at the top of your game.',1),
 ('Brawler','There are always opportunities for people willing and able to knock some heads together. It’s not fancy fighting, and it’s certainly not fair, but you’d much rather have a reputation for winning and surviving than anything else.',0),
 ('Clergy','People need faith. They need someone to look after their hearts and souls just as much as bodies or minds, perhaps even more so in some ways. You have a calling to do this work, along with tending to your own faith—whatever form that might take.',1),
 ('Commander','You’re trained to lead military personnel in the field, as a noble calling or part of a professional elite. Your responsibility is to get the job done and to ensure as many of those under your command make it back as possible. Does a good commander put the first goal ahead of the second, or vice versa?',3),
 ('Criminal','When you’re on the outside, you often bend and break the law to survive. You might feel you have no choice in the matter because of circumstances, or maybe you chose those circumstances, loving crime with professional pride, or as a means to some political or personal end. Either way, you know how to work around the law.',0),
 ('Dilettante','With so many possible things to learn and do, how can you choose? You’re happy to sample from the banquet of possibilities laid out before you, learning as much as you can about something before moving on to the next interest or option.',3),
 ('Executive','You are the take-charge type, able to see the big picture and organize people to get things done to move towards those goals. You need vision and the ability to lead people toward it. You decide whether it’s all about profit, about the thrill of your ventures, or some other agenda.',3),
 ('Expert','There used to be a time when you could know everything, or nearly so, but that’s long gone. Still, you’re an expert in your chosen field. Experts tend to belong to highly paid and complex fields including finance, law, medicine, and the sciences.',3),
 ('Explorer','There are still plenty of places in the System where few if any people have been, and you want to explore them. Your work might be for the expansion of human knowledge and achievement or simply to satisfy your own need to discover someplace new.',3),
 ('Fixer','You are good at getting things done, often in a less-than-strictly-legal fashion or outside of the normal channels.  While some Fixers are motivated by profit, others do what they can to help people within the context of a restrictive and often corrupt system.',0),
 ('Investigator','People lie and keep secrets. They’ve been doing it since the dawn of time. Likewise, people like you, who know how to dig up the truth, have always dogged deceivers. You might bring criminals to justice, get information to the public, or find out what a client wants or needs to know.',1),
 ('Merchant','Money makes the world go around, and you are a part of that time-honored tradition. You know how to buy at a discount, sell at a profit, and make trades that ensure you come out ahead of the game. You might be involved in trade, work in retail or wholesale, or deal in rarities that require knowledge to identify and eloquence to sell.',2),
 ('Negotiator','The harder things are, the more people need each other to get by and the more likely it seems they are to disagree.You know how to get people together, to settle disputes, to find compromises, and to generally grease the rusty wheels of conflicting agendas so they turn in unison once more.',1),
 ('Pilot','You are at your best when you’re at the controls. You have the nerve and the skill needed to make your ship do what you need it to do. It becomes an extension of your body, its humming as essential as the beat of your heart.',2),
 ('Politician','From neighborhoods to nations, people need to be organized for society to function. You know the tricks it takes  to get people to cooperate in that process, sometimes whether they want to or not. Your speeches help people devise collective political dreams, but behind closed doors you deal in the art of the possible. You might be virtuous or corrupt, but isn’t that a matter of perspective?',2),
 ('Professional','Whether from time toiling in a cubicle farm or your own private office, you know the “white collar” professional world. You might see it as a career path or a stepping stone towards something else, but you know your job and the skills and challenges that come with it.',2),
 ('Scavenger','Most people would be amazed at the things that get thrown away and forgotten, but not you. You are all too familiar with that bounty: how to find it, salvage it, and make the best use of it.',0),
 ('Scholar','Knowledge and understanding are your fields, focused on a specific area of interest. Whereas the expert profession tends to be about applied knowledge, you focus on knowledge for knowledge’s sake. You might work in a university,  or have an amateur obsession. You look to expand your own understanding of your field and, in so doing, perhaps expand the world’s understanding as well.',2),
 ...
 ('Socialite','Life is a never-ending series of social engagements, fromparties and receptions to fundraisers, weddings, and even funerals, and you navigate all of them with style. Your social obligations might be a burden or a source of enjoyment for you but, whatever the case, they’re yours, and you handle them well. You might lead a life of pure recreation, but your engagements could have political or charitable dimensions as well.',3),
 ('Soldier','Your nation and people need someone to defend them, to stand on the front lines and, sometimes, to go to war against their enemies. You’re trained to follow orders, to fight, and to do what needs doing. Rather than duty to home and country, you might be a soldier-for-hire, working for whatever client can meet your fee.',1),
 ('Survivalist','Survival is the most basic challenge of life, and you have learned how to do it, whether because you had to or because you prefer it that way. You know how to make do without many of the products and social networks most people depend upon for their everyday lives.',0),
 ('Technician','You fix things. Whether you’re a mechanic, maintenance technician, or even work in information technologies, people depend on you to keep it working. You might work in vast server farms, in lightless tunnels, in a massive factory, or in a nondescript office. These are all points where you maintain part of the System’s vast infrastructure.',1);
INSERT INTO "ProfessionFocus" ("ProfessionName","AbilityId","FocusName") VALUES ('Artist',3,'Expression'),
 ('Artist',5,'Art'),
 ('Athlete',1,'Running'),
 ('Athlete',1,'Swimming'),
 ('Athlete',4,'Acrobatics'),
 ('Athlete',4,'Free-fall'),
 ('Athlete',7,'Climbing'),
 ('Athlete',7,'Jumping'),
 ('Brawler',2,'Brawling'),
 ...
 ('Commander',5,'Tactics'),
 ('Criminal',3,'Deception'),
 ('Criminal',4,'Forgery'),
 ('Criminal',4,'Sleight of Hand'),
 ('Criminal',4,'Stealth'),
 ('Dilettante',5,'Research'),
 ('Executive',3,'Leadership'),
 ('Executive',5,'Business'),
 ('Explorer',5,'Navigation'),
 ('Fixer',3,'Bargaining'),
 ('Fixer',5,'Evaluation'),
 ('Investigator',3,'Investigation'),
 ('Merchant',3,'Bargaining'),
 ('Merchant',5,'Business'),
 ('Negotiator',3,'Bargaining'),
 ('Negotiator',3,'Persuasion'),
 ('Negotiator',6,'Empathy'),
 ('Pilot',4,'Piloting'),
 ('Politician',3,'Deception'),
 ('Politician',3,'Persuasion'),
 ('Politician',5,'Current Affairs'),
 ('Politician',5,'Law'),
 ('Professional',3,'Bargaining'),
 ('Professional',3,'Expression'),
 ('Professional',5,'Business'),
 ('Professional',5,'Technology'),
 ('Professional',5,'Research'),
 ('Scavenger',5,'Technology'),
 ('Scavenger',6,'Searching'),
 ('Security',5,'Security'),
 ('Security',6,'Empathy'),
 ('Security',6,'Intuition'),
 ('Security',6,'Seeing'),
 ('Socialite',3,'Etiquette'),
 ('Socialite',3,'Seduction'),
 ('Socialite',1,'Tolerance'),
 ('Soldier',0,'Pistols'),
 ('Soldier',0,'Rifles'),
 ('Soldier',2,'Brawling'),
 ('Survivalist',0,'Bows'),
 ('Survivalist',0,'Pistols'),
 ('Survivalist',6,'Survival'),
 ('Technician',5,'Engineering'),
 ('Technician',5,'Technology'),
 ('Dilettante',6,'Empathy'),
 ('Dilettante',6,'Hearing'),
 ('Dilettante',6,'Intuition'),
 ('Dilettante',6,'Searching'),
 ('Dilettante',6,'Seeing'),
 ('Dilettante',6,'Smelling'),
 ('Dilettante',6,'Survival'),
 ('Dilettante',6,'Tasting'),
 ('Dilettante',6,'Touching'),
 ('Dilettante',6,'Tracking'),
 ('Expert',5,'Art'),
 ('Expert',5,'Business'),
 ('Expert',5,'Cryptography'),
 ('Expert',5,'Current Affairs'),
 ('Expert',5,'Demolitions'),
 ...
 ('Scholar',5,'Art'),
 ('Scholar',5,'Business'),
 ('Scholar',5,'Cryptography'),
 ('Scholar',5,'Current Affairs'),
 ('Scholar',5,'Demolitions'),
 ('Scholar',5,'Engineering'),
 ('Scholar',5,'Evaluation'),
 ('Scholar',5,'History'),
 ('Scholar',5,'Law'),
 ('Scholar',5,'Medicine'),
 ('Scholar',5,'Navigation'),
 ('Scholar',5,'Research'),
 ('Scholar',5,'Science'),
 ('Scholar',5,'Security'),
 ('Scholar',5,'Tactics'),
 ('Scholar',5,'Technology'),
 ('Scholar',5,'Theology'),
 ('Explorer',6,'Empathy'),
 ('Explorer',6,'Hearing'),
 ('Explorer',6,'Intuition'),
 ('Explorer',6,'Searching'),
 ('Explorer',6,'Seeing'),
 ('Explorer',6,'Smelling'),
 ('Explorer',6,'Survival'),
 ('Explorer',6,'Tasting'),
 ('Explorer',6,'Touching'),
 ('Explorer',6,'Tracking'),
 ('Investigator',6,'Empathy'),
 ('Investigator',6,'Hearing'),
 ('Investigator',6,'Intuition'),
 ('Investigator',6,'Searching'),
 ('Investigator',6,'Seeing'),
 ('Investigator',6,'Smelling'),
 ('Investigator',6,'Survival'),
 ('Investigator',6,'Tasting'),
 ('Investigator',6,'Touching'),
 ('Investigator',6,'Tracking');
COMMIT;
